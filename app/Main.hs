...
generateShell indentLevel dat =
 catDot ["devShells", archToString (arch dat), "default"]
  ++ " = pkgs.mkShell "
  ++ generateSet
   indentLevel
...
generateOutputs indentLevel dat =
